...
st.set_page_config(page_title='EDA Financial Forecasting', layout='wide')
st.title('EDA Financial Forecasting')
...
get_ipython().system('pip install plotly seaborn matplotlib pandas numpy scipy scikit-learn')
...
if __name__ == "__main__":
    ...
    from your_preprocessing_module import run_fixed_preprocessing
    arimax_processed, lstm_processed = run_fixed_preprocessing()
